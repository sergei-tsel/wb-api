...
#### Реализовано стягивание всех данных с сохранением в базе данных

- Имя: f1065899_wb_api
- Пользователь: f1065899_wb_api
- Пароль: RuZdYGud
- Адрес хоста: localhost

[Ссылка на хостинг Спринтхост, на который импортирован файл, созданный путём ручного запуска mysqldump](https://cp.sprinthost.ru/main/index)
